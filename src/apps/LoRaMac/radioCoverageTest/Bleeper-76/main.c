...
int main( void )
{
    ...
    { 
        { 433100000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 433300000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 433500000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 434100000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 434300000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 434500000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 434700000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 434900000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
     };
#elif defined( USE_BAND_470 )
    const ChannelParams_t channels[] =
    { 
        { 471300000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 471500000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 471700000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 471900000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 473200000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 473400000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 473600000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 473800000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
     };
    ...
    const ChannelParams_t channels[] =
    { 
        { 902300000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 902500000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 902700000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 902900000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 903100000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 903500000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 903700000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
        { 903900000, { ( ( DR_5 << 4 ) | DR_0 ) }, 1 },
     };
#else
