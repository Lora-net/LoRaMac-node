...
{
     GpioInit( &AntSwitch, RADIO_ANT_SWITCH_RXTX, PIN_OUTPUT, PIN_PUSH_PULL, PIN_PULL_UP, 1 );
}

void SX1276AntSwDeInit( void )
{
    GpioInit( &AntSwitch, RADIO_ANT_SWITCH_RXTX, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
}
