...
const network_keys_t AS923_network_keys_eu1 = {
...
const network_keys_t AS923_network_keys_au1 = {
...
const network_keys_t *eu868_region_keys[] = {&EU868_network_keys, &helium_network_keys};
const network_keys_t *us915_region_keys[] = {&US915_network_keys, &helium_network_keys};
const network_keys_t *as923_region_keys[] = {&helium_network_keys, &AS923_network_keys_eu1, &AS923_network_keys_au1}; // In japan, start with helium network first, then go through ttn end node registered on EU cluster then AU cluster
const network_keys_t *ru864_region_keys[] = {&RU864_network_keys, &helium_network_keys};
const network_keys_t *au915_region_keys[] = {&AU915_network_keys, &helium_network_keys};
const network_keys_t *kr920_region_keys[] = {&KR920_network_keys, &helium_network_keys}; // update keys, possibly to AU1
const network_keys_t *in865_region_keys[] = {&IN865_network_keys, &helium_network_keys};
const network_keys_t *cn470_region_keys[] = {&CN470_network_keys, &helium_network_keys};
...
network_keys_t get_next_network_keys_in_region(LoRaMacRegion_t region)
{
    ...
    case LORAMAC_REGION_AS923:
        network_keys = *as923_region_keys[counter % (sizeof(as923_region_keys) / sizeof(as923_region_keys[0]))];
        break;

    case LORAMAC_REGION_AU915:
        network_keys = *au915_region_keys[counter % (sizeof(au915_region_keys) / sizeof(au915_region_keys[0]))];
        break;

    case LORAMAC_REGION_CN470:
        network_keys = *cn470_region_keys[counter % (sizeof(cn470_region_keys) / sizeof(cn470_region_keys[0]))];
        break;

    case LORAMAC_REGION_EU868:
        network_keys = *eu868_region_keys[counter % (sizeof(eu868_region_keys) / sizeof(eu868_region_keys[0]))];
        break;

    case LORAMAC_REGION_KR920:
        network_keys = *kr920_region_keys[counter % (sizeof(kr920_region_keys) / sizeof(kr920_region_keys[0]))];
        break;

    case LORAMAC_REGION_IN865:
        network_keys = *in865_region_keys[counter % (sizeof(in865_region_keys) / sizeof(in865_region_keys[0]))];
        break;

    case LORAMAC_REGION_US915:
        network_keys = *us915_region_keys[counter % (sizeof(us915_region_keys) / sizeof(us915_region_keys[0]))];
        break;

    case LORAMAC_REGION_RU864:
        network_keys = *ru864_region_keys[counter % (sizeof(ru864_region_keys) / sizeof(ru864_region_keys[0]))];
        break;

    default:
        network_keys = *eu868_region_keys[counter % (sizeof(eu868_region_keys) / sizeof(eu868_region_keys[0]))]; // Use EU frequencies if all fails
        break;
    }
