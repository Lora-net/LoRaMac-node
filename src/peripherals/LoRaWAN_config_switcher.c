...
const network_keys_t network_key_list[] = {
    ...
    {
        .FNwkSIntKey_SNwkSIntKey_NwkSEncKey = COMMON_EU868_KEYS,
    ...
    {
        .FNwkSIntKey_SNwkSIntKey_NwkSEncKey = COMMON_HELIUM_KEYS,
    ...
    {
        .FNwkSIntKey_SNwkSIntKey_NwkSEncKey = COMMON_US915_KEYS,
