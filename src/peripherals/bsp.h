...
#define LORAMAC_REGION_EEPROM_ADDR (TX_INTERVAL_EEPROM_LEN + NVM_PlAYBACK_EEPROM_ADDR_START)
#define LORAMAC_REGION_EEPROM_LEN (4)

#define RESET_COUNTER_ADDR (LORAMAC_REGION_EEPROM_LEN + LORAMAC_REGION_EEPROM_ADDR)
#define RESET_COUNTER_LEN (2)

#define CURRENT_PLAYBACK_INDEX_IN_EEPROM_ADDR (RESET_COUNTER_LEN + RESET_COUNTER_ADDR)
#define CURRENT_PLAYBACK_INDEX_IN_EEPROM_LEN (2 + 2 + 4)

#define PLAYBACK_EEPROM_ADDR_START (CURRENT_PLAYBACK_INDEX_IN_EEPROM_LEN + CURRENT_PLAYBACK_INDEX_IN_EEPROM_ADDR)
