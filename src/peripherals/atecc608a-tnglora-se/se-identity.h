 ...
 * When set to 0 DevEui is the one provided by the secure-element
 */
...
/*!
 * When set to 1 JoinEui is LORAWAN_DEVICE_EUI
 * When set to 0 JoinEui is the one provided by the secure-element
 */
#define STATIC_JOIN_EUI                                    0
