...
bool RegionEU433RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    if( dr == DR_7 )
    {
        Radio.SetMaxPayloadLength( MODEM_FSK, MaxPayloadOfDatarateEU433[dr] + LORAMAC_FRAME_PAYLOAD_OVERHEAD_SIZE );
    ...
    {
        Radio.SetMaxPayloadLength( MODEM_LORA, MaxPayloadOfDatarateEU433[dr] + LORAMAC_FRAME_PAYLOAD_OVERHEAD_SIZE );
