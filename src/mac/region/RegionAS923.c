...
bool RegionAS923RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    if( dr == DR_7 )
    {
        Radio.SetMaxPayloadLength( MODEM_FSK, MaxPayloadOfDatarateDwell0AS923[dr] + LORAMAC_FRAME_PAYLOAD_OVERHEAD_SIZE );
    ...
    {
        Radio.SetMaxPayloadLength( MODEM_LORA, MaxPayloadOfDatarateDwell0AS923[dr] + LORAMAC_FRAME_PAYLOAD_OVERHEAD_SIZE );
