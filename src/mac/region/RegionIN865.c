...
bool RegionIN865RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    if( dr == DR_7 )
    {
        loramac_radio_gfsk_cfg_params_t gfsk_params = {
            ...
            .sync_word_len_in_bits = 24,
            .is_pkt_len_fixed = false,
            .pld_len_in_bytes = ( uint8_t )( MaxPayloadOfDatarateIN865[dr] + LORAMAC_FRAME_PAYLOAD_OVERHEAD_SIZE ),
            .is_crc_on = true,
    ...
    if( dr == DR_7 )
    {
        Radio.SetMaxPayloadLength( MODEM_FSK, MaxPayloadOfDatarateIN865[dr] + LORAMAC_FRAME_PAYLOAD_OVERHEAD_SIZE );
    ...
    {
        Radio.SetMaxPayloadLength( MODEM_LORA, MaxPayloadOfDatarateIN865[dr] + LORAMAC_FRAME_PAYLOAD_OVERHEAD_SIZE );
