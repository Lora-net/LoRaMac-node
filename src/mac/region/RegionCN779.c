...
void RegionCN779GetPhyParam( GetPhyParams_t* getPhy )
{
    switch( getPhy->Attribute )
    {
        case PHY_MIN_RX_DR:
        {
            getPhy->Param.Value = CN779_RX_MIN_DATARATE;
            break;
        }
        case PHY_MIN_TX_DR:
        {
...
bool RegionCN779RxConfig( RxConfigParams_t* rxConfig, int8_t* datarate )
{
    ...
    if( rxConfig->Window == 0 )
    {
        ...
        dr = RegionCN779ApplyDrOffset( rxConfig->DownlinkDwellTime, dr, rxConfig->DrOffset );
...
bool RegionCN779TxConfig( TxConfigParams_t* txConfig, int8_t* txPower, TimerTime_t* txTimeOnAir )
{
    ...
    phyTxPower = TxPowersCN779[txPowerLimited];
